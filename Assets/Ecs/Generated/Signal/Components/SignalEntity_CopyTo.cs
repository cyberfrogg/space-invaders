...
public partial class SignalEntity
{
	...
	public void CopyComponentTo(IComponent component)
	{
		...
		else if (component is Ecs.Signal.Components.SignalStartComponent SignalStart)
		{
			IsSignalStart = true;
		}
		else if (component is SignalDestroyedAddedListenerComponent SignalDestroyedAddedListener)
		{
			CopySignalDestroyedAddedListenerTo(SignalDestroyedAddedListener);
		}
		#endif
	}
	...
	/// </summary>
	public void CopyTo(SignalEntity copyToEntity)
	{
		for (var i = 0; i < SignalComponentsLookup.TotalComponents; ++i)
		{
			if (HasComponent(i))
			{
				if (copyToEntity.HasComponent(i))
				{
					throw new EntityAlreadyHasComponentException(
						...
						SignalComponentsLookup.ComponentNames[i] +
						"' to " +
						this +
						"!",
	...
	/// </summary>
	public void CopyTo(SignalEntity copyToEntity, bool replaceExisting)
	{
		for (var i = 0; i < SignalComponentsLookup.TotalComponents; ++i)
		{
			if (!HasComponent(i))
	...
	/// <summary>
	/// Copies components on this entity at <paramref name="indices"/> in the <see cref="SignalComponentsLookup"/> to
	...
	/// </summary>
	public void CopyTo(SignalEntity copyToEntity, bool replaceExisting, params int[] indices)
	{
		for (var i = 0; i < indices.Length; ++i)
		{
			...
			if (index < 0 && index >= SignalComponentsLookup.TotalComponents)
			{
				...
				throw new IndexOutOfLookupRangeException(
					string.Format(OUT_OF_RANGE_WARNING, index, nameof(SignalComponentsLookup)),
					HINT);
			}
